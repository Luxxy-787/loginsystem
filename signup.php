...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($numExistRows > 0) {
    ...
    if (($password == $cpassword)) {
      ...
      $sql = "INSERT INTO `users_data` ( `usernames`, `email`, `password`, `dt`) VALUES ('$usernames', '$email', '$hash', NOW())";
  ...
  <div class="container">
    <div class="forms-container">
      <div class="signin-signup">
        <form action="/LoginSystem/signup.php" class="sign-up-form" method="post">
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          ...
          <button onclick="redirectToLogin()" class="btn transparent" id="sign-in-btn">Sign in - ajax</button>
        </div>
